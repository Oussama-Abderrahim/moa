 ...
 * @version $Revision: 7 $
 */
public class HybridVFDT extends AbstractClassifier implements MultiClassClassifier, CapabilitiesHandler {
    ...
    public static class Node extends AbstractMOAObject {
        ...
        public double[] getClassVotes(Instance inst, HybridVFDT ht) {
            return this.observedClassDistribution.getArrayCopy();
        }
        ...
        public void describeSubtree(HybridVFDT ht, StringBuilder out,
                                    int indent) {
    ...
    public static abstract class LearningNode extends Node {
        ...
        public abstract void learnFromInstance(Instance inst, HybridVFDT ht);
    }
    ...
    public static class InactiveLearningNode extends LearningNode {
        ...
        @Override
        public void learnFromInstance(Instance inst, HybridVFDT ht) {
    ...
    public static class ActiveLearningNode extends LearningNode {
        ...
        public AttributeSplitSuggestion[] getBestSplitSuggestions(SplitCriterion criterion, HybridVFDT ht) {
    ...
    protected void attemptToSplit(ActiveLearningNode node, SplitNode parent, int parentIndex) {
        ...
        SplitCriterion secondSplitCriterion = (SplitCriterion) getPreparedClassOption(this.splitCriterionOption);
