...
public class HybridEFDT extends AbstractClassifier implements MultiClassClassifier {
    ...
    public interface EFDTNode {
        ...
        void learnFromInstance(Instance inst, HybridEFDT ht, EFDTSplitNode parent, int parentBranch);
    ...
    public static class Node extends AbstractMOAObject {
        ...
        public double[] getClassVotes(Instance inst, HybridEFDT ht) {
            return this.observedClassDistribution.getArrayCopy();
        }
        ...
        public void describeSubtree(HybridEFDT ht, StringBuilder out,
                                    int indent) {
    ...
    public class EFDTSplitNode extends SplitNode implements EFDTNode {
        ...
        public void killSubtree(HybridEFDT ht) {
            for (Node child : this.children) {
                if (child != null) {
        ...
        public AttributeSplitSuggestion[] getBestSplitSuggestions(
                SplitCriterion criterion, HybridEFDT ht) {
        ...
        @Override
        public void learnFromInstance(Instance inst, HybridEFDT ht, EFDTSplitNode parent, int parentBranch) {
    ...
    public static abstract class LearningNode extends Node {
        ...
        public abstract void learnFromInstance(Instance inst, HybridEFDT ht);
    }
    ...
    public class EFDTLearningNode extends LearningNodeNBAdaptive implements EFDTNode {
        ...
        @Override
        public void learnFromInstance(Instance inst, HybridEFDT ht) {
