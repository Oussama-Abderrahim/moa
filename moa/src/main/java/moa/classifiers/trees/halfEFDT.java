...
public class halfEFDT extends AbstractClassifier implements MultiClassClassifier {
    ...
    public static double computeHoeffdingBound(double range, double confidence, double n) {
        return 0.5 * Math.sqrt(((range * range) * Math.log(1.0 / confidence))
                / (2.0 * n));
    }
    ...
    public interface EFDTNode {
        ...
        void learnFromInstance(Instance inst, halfEFDT ht, EFDTSplitNode parent, int parentBranch);
    ...
    public static class Node extends AbstractMOAObject {
        ...
        public double[] getClassVotes(Instance inst, halfEFDT ht) {
            return this.observedClassDistribution.getArrayCopy();
        }
        ...
        public void describeSubtree(halfEFDT ht, StringBuilder out,
                                    int indent) {
    ...
    public class EFDTSplitNode extends SplitNode implements EFDTNode {
        ...
        public void killSubtree(halfEFDT ht) {
            for (Node child : this.children) {
                if (child != null) {
        ...
        public AttributeSplitSuggestion[] getBestSplitSuggestions(
                SplitCriterion criterion, halfEFDT ht) {
        ...
        @Override
        public void learnFromInstance(Instance inst, halfEFDT ht, EFDTSplitNode parent, int parentBranch) {
        ...
        protected void reEvaluateBestSplit(EFDTSplitNode node, EFDTSplitNode parent,
            ...
            SplitCriterion splitCriterion = (SplitCriterion) getPreparedClassOption(halfEFDT.this.splitCriterionOption);
            double hoeffdingBound = computeHoeffdingBound(splitCriterion.getRangeOfMerit(node.getClassDistributionAtTimeOfCreation()),
                    halfEFDT.this.splitConfidenceOption.getValue(), node.observedClassDistribution.sumOfValues());

            // get best split suggestions
            AttributeSplitSuggestion[] bestSplitSuggestions = node.getBestSplitSuggestions(splitCriterion, halfEFDT.this);
            Arrays.sort(bestSplitSuggestions);
            ...
            double tieThreshold = halfEFDT.this.tieThresholdOption.getValue();
            ...
            if (deltaG > hoeffdingBound
                ...
                if (splitDecision.splitTest == null) {
                    ...
                    node.killSubtree(halfEFDT.this);
                    ...
                    if (node.splitTest == splitDecision.splitTest
                        ...
                        this.killSubtree(halfEFDT.this);
                        ...
                        halfEFDT.this.activeLeafNodeCount--;
                        halfEFDT.this.decisionNodeCount++;
                        halfEFDT.this.activeLeafNodeCount += splitDecision.numSplits();
                    ...
                    if (parent == null) {
                        ...
                        halfEFDT.this.treeRoot = newSplit;
                    } else {
    ...
    public static abstract class LearningNode extends Node {
        ...
        public abstract void learnFromInstance(Instance inst, halfEFDT ht);
    }
    ...
    public class EFDTLearningNode extends LearningNodeNBAdaptive implements EFDTNode {
        ...
        @Override
        public void learnFromInstance(Instance inst, halfEFDT ht) {
    ...
    static class VFDT extends halfEFDT {
